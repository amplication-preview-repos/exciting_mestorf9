...
const CREATE_INPUT = {
  ...
  id: "exampleId",
  nomeCompleto: "exampleNomeCompleto",
  nomeDaMae: "exampleNomeDaMae",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  createdAt: new Date(),
  ...
  test("POST /pacientes", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dataDeNascimento: CREATE_RESULT.dataDeNascimento.toISOString(),
      ...
      .expect([
        {
          ...
          dataDeNascimento: FIND_MANY_RESULT[0].dataDeNascimento.toISOString(),
  ...
  test("GET /pacientes/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dataDeNascimento: FIND_ONE_RESULT.dataDeNascimento.toISOString(),
